...
contextBridge.exposeInMainWorld('floatingAPI', {
  ...
  getSpeechProvider: () => ipcRenderer.invoke('get-speech-provider'),
  getDeepgramStreamingConfig: () => ipcRenderer.invoke('get-deepgram-streaming-config'),
  ...
  getInterviewSummary: () => ipcRenderer.invoke('get-interview-summary'),
  ...
  getSessionMinimized: () => ipcRenderer.invoke('getSessionMinimized'),
  ...
  getPendingAskQuestion: () => ipcRenderer.invoke('getPendingAskQuestion'),
  ...
  getResume: (resumeId) => ipcRenderer.invoke('get-resume', resumeId),
  uploadResume: (opts) => ipcRenderer.invoke('upload-resume', opts),
